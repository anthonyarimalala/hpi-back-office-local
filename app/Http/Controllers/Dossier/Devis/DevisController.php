...
class DevisController extends Controller
{
    ...
    public function getFilterListeDevis(Request $request){
        $filters = [
            ...
            'part_secu_non_regle' => $request->input('part_secu_non_regle'),
            ...
            'part_mutuelle_non_regle' => $request->input('part_mutuelle_non_regle'),
            ...
            'part_rac_non_regle' => $request->input('part_rac_non_regle'),
