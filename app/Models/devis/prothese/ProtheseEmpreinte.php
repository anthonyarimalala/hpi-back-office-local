...
class ProtheseEmpreinte extends Model
{
    ...
    public static function createOrUpdateEmpreinte($m_h_prothese, $id_devis, $laboratoire, $date_empreinte, $date_envoi_labo, $travail_demande, $numero_dent, $observations, &$withChangeProthese = false) {
