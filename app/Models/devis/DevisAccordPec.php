...
class DevisAccordPec extends Model
{
    ...
    public function createDevisAccordPecs($id_devis, $date_envoi_pec, $date_fin_validite_pec, $part_mutuelle, $part_rac)
    {
        $m_devisAccordPecs = new DevisAccordPec();
        $m_devisAccordPecs->id_devis = $id_devis;
