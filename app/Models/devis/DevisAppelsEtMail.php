...
class DevisAppelsEtMail extends Model
{
    ...
    public function createDevisAppelsEtMail($id_devis, $date_1er_appel, $note_1er_appel, $date_2eme_appel, $note_2eme_appel, $date_3eme_appel, $note_3eme_appel, $date_envoi_mail){
        $m_devis_appels_et_mail = new DevisAppelsEtMail();
