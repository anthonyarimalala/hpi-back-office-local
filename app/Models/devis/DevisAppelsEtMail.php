...
class DevisAppelsEtMail extends Model
{
    ...
    public static function createDevisAppelsEtMail($m_h_devis, $id_devis, $date_1er_appel, $note_1er_appel, $date_2eme_appel = null, $note_2eme_appel = null, $date_3eme_appel = null, $note_3eme_appel = null, $date_envoi_mail = null, &$withChange = false) {
        // Conversion de la date du 1er appel en DateTime si nécessaire
        if ($date_1er_appel && !($date_1er_appel instanceof \DateTime)) {
            $date_1er_appel = new \DateTime($date_1er_appel);
        }
