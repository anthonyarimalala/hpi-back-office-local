                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="dossier" name="dossier" value="{{ $v_ca_actes_reglement->dossier }}" placeholder="Numéro de dossier" required readonly></td>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" min="0" step="0.01" class="form-control" id="rcsb_cb" name="rcsb_cb" value="{{ $v_ca_actes_reglement->rcsb_cb }}" placeholder="Montant CB"></td>
                                </tr>
                                </tbody>
                            </table>
