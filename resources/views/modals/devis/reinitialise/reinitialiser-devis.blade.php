<div class="modal fade" id="reinitialiseModal" tabindex="-1" aria-labelledby="reinitialiseModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="importForm" action="{{ asset('reinitialiser-devis/1') }}" method="GET" class="forms-sample"
