                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="myTable">
                            ...
                            <tr>
                                ...
                                <th class="infoAccordPec" colspan="5" style="background-color: #f8f9fa; text-align: center; border-right: 2px solid #000;">INFO ACCORD PEC</th>
                            ...
                            <tr>
                                ...
                                <!-- 10 -->
                                <th onclick="sortTableByNumber('myTable', 10)" class="infoAccordPec">Part sécu<span id="sort-icon-0" class="mdi mdi-sort"></span></th>
                            ...
                            @foreach($deviss as $devis)
                                <tr style="background-color: {{ $devis->couleur }};" onmouseover="this.style.backgroundColor='#d3d3d3';" onmouseout="this.style.backgroundColor='{{ $devis->couleur }}';">
                                    <!-- INFO DEVIS -->
                                    <td class="infoCheques" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        <strong>{{ $devis->dossier }}</strong>
                                    </td>
                                    <td class="infoCheques" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; word-wrap: break-word; max-width: 150px; overflow: hidden; text-overflow: ellipsis;">
                                        {{ $devis->nom }}
                                    </td>
                                    <td class="infoCheques" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->status }}
                                    ...
                                    <td class="infoCheques" style="border-right: 2px solid #000;" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->praticien }}
                                    </td>

                                    <!-- INFO ACCORD PEC -->
                                    <td class="infoAccordPec" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_envoi_pec() }}
                                    </td>
                                    <td class="infoAccordPec" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_fin_validite_pec() }}
                                    </td>
                                    <td class="infoAccordPec" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; @foreach($devis_accord_pecs_status as $da) @if($da->status == $devis->part_secu_status) background-color: {{ $da->couleur }} @endif @endforeach">
                                        {{ $devis->getPart_secu() }}
                                    </td>
                                    <td class="infoAccordPec" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; @foreach($devis_accord_pecs_status as $da) @if($da->status == $devis->part_mutuelle_status) background-color: {{ $da->couleur }} @endif @endforeach">
                                        {{ $devis->getPart_mutuelle() }}
                                    </td>
                                    <td class="infoAccordPec" style="border-right: 2px solid #000;" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; @foreach($devis_accord_pecs_status as $da) @if($da->status == $devis->part_rac_status) background-color: {{ $da->couleur }} @endif @endforeach">
                                        {{ $devis->getPart_rac() }}
                                    </td>

                                    <!-- APPELS & MAIL -->
                                    <td class="appelsMail" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_1er_appel() }}
                                    </td>
                                    <td class="appelsMail" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; word-wrap: break-word; max-width: 175px; overflow: hidden; text-overflow: ellipsis;">
                                    ...
                                    <td class="appelsMail" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; border-right: 2px solid #000;">
                                        {{ $devis->getDate_envoi_mail() }}
                                    </td>
                                    <td class="infoEmpreinte" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                    ...
                                    <td class="infoEmpreinte" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; border-right: 2px solid #000;">
                                        {{ $devis->getObservations() }}
                                    </td>
                                    <td class="retourLabo" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_livraison() }}
                                    </td>
                                    <td class="retourLabo" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getNumero_suivi() }}
                                    </td>
                                    <td class="retourLabo" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; border-right: 2px solid #000;">
                                        {{ $devis->getNumero_facture_labo() }}
                                    </td>
                                    <td class="pose" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_pose_prevue() }}
                                    </td>
                                    <td class="pose" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer; border-right: 2px solid #000;">
                                        {{ $devis->getPoseStatut() }}
                                    </td>
                                    <td class="pose" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getDate_pose_reel() }}
                                    </td>
                                    <td class="travauxCloture" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getOrganisme_payeur() }}
                                    </td>
                                    <td class="travauxCloture" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                                        {{ $devis->getMontant_encaisse() }}
                                    </td>
                                    <td class="travauxCloture" style="border-right: 2px solid #000;" ondblclick="window.location.href='devis/{{ $devis->id_devis }}/acte{{ $devis->id_acte }}/detail';" style="cursor:pointer;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            @foreach($ca_actes_reglements as $ca)
                                <tr ondblclick="window.location.href='{{ asset('ca/'.$ca->id.'/'.$ca->dossier.'/modifier') }}';">
                                    <td>
                                    ...
                                    <td ondblclick="event.stopPropagation()"><a href="{{ asset('delete-ca/'. $ca->id ) }}" ondblclick="return deleteItem('<?= $ca->dossier ?>', '<?= $ca->created_at ?>')">Supprimer</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
