                    ...
                    <div class="card card-rounded">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                    <h4 class="card-title card-title-dash">Anomalies CA: </h4>
                                </div>
                                @if (session('success'))
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($ca_actes_reglements as $ca)
                                        @php
                                            ...
                                            $anom_rc = false;
                                            $anom_rac = false;
                                            if (($ca->cotation_paye ?? 0) > ($ca->cotation ?? 0)) $anom_cotation = true;
                                            if (($ca->ro_part_secu_paye ?? 0) > ($ca->ro_part_secu ?? 0)) $anom_ro = true;
                                            if (($ca->part_mutuelle_paye ?? 0) > ($ca->part_mutuelle ?? 0)) $anom_rc = true;
                                            if (($ca->rac_part_patient_paye ?? 0) > ($ca->rac_part_patient ?? 0)) $anom_rac = true;
                                        ...
                                        <tr onclick="window.location.href='{{ asset('ca/'.$ca->id.'/'.$ca->dossier.'/modifier') }}';">
                                            ...
                                            <td>{{ $ca->praticien }}</td>
                                            <td>{{ $ca->nom_acte }}</td>
                                            <td class="text-end" @if($anom_cotation) style="background-color: red" @endif>@if($ca->cotation){{ number_format($ca->cotation, 2, ',', ' ') }}@endif</td>
                                            <td style="border-right: 2px solid #000;">{{ $ca->controle_securisation }}</td>
                                            <td class="text-end" style="@if($anom_ro) background-color: red; @endif">@if($ca->ro_part_secu){{ number_format($ca->ro_part_secu, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_ro) background-color: red; @endif">@if($ca->ro_virement_recu){{ number_format($ca->ro_virement_recu, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_ro) background-color: red; @endif">@if($ca->ro_indus_paye){{ number_format($ca->ro_indus_paye, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_ro) background-color: red; @endif">@if($ca->ro_indus_en_attente){{ number_format($ca->ro_indus_en_attente, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_ro) background-color: red; @endif border-right: 2px solid #000;">@if($ca->ro_indus_irrecouvrable){{ number_format($ca->ro_indus_irrecouvrable, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif border-right: 2px solid #000;">@if($ca->part_mutuelle){{ number_format($ca->part_mutuelle, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif">@if($ca->rcs_virement){{ number_format($ca->rcs_virement, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif">@if($ca->rcs_especes){{ number_format($ca->rcs_especes, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif border-right: 2px solid #000;">@if($ca->rcs_cb){{ number_format($ca->rcs_cb, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif">@if($ca->rcsd_cheque){{ number_format($ca->rcsd_cheque, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif">@if($ca->rcsd_especes){{ number_format($ca->rcsd_especes, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rc) background-color: red; @endif border-right: 2px solid #000;">@if($ca->rcsd_cb){{ number_format($ca->rcsd_cb, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rac) background-color: red; @endif">@if($ca->rac_part_patient){{ number_format($ca->rac_part_patient, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rac) background-color: red; @endif">@if($ca->rac_cheque){{ number_format($ca->rac_cheque, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rac) background-color: red; @endif">@if($ca->rac_especes){{ number_format($ca->rac_especes, 2, ',', ' ') }}@endif</td>
                                            <td class="text-end" style="@if($anom_rac) background-color: red; @endif border-right: 2px solid #000;">@if($ca->rac_cb){{ number_format($ca->rac_cb, 2, ',', ' ') }}@endif</td>
